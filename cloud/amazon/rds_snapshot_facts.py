...
# Search all snapshots, filter the IDs by regular expression and sort by ID
- local_action:
    module: rds_snapshot_facts
    id_regex: "^my-instance-.+$"
    sort: id
    sort_order: descending
    status: available
'''
...
RETURN = '''
allocated_storage:
  description: The amount of storage allocated, in GB
  returned: success
  type: int
  sample: 100
availability_zone:
  description: Availability zone of the source instance
  returned: success
  type: str
  sample: "us-west-2b"
engine_version:
  description: Version of the database engine from the source instance
  returned: success
  type: str
  sample: "9.3.6"
id:
  ...
  returned: success
  type: str
  sample: "rds:my-instance-2016-02-21-09-25"
instance_create_time:
  description: When the source instance was created
  returned: success
  type: str
  sample: "2015-11-17T13:01:31.951Z"
instance_id:
  ...
  sample: "my-instance"
iops:
  description: IOPS allocated when provisioned IOPS storage is used
  returned: success
  type: int
  sample: 1500
master_username:
  ...
  sample: "mesuper"
option_group_name:
  description: The option group name used for the source instance
  returned: success
  type: str
  sample: "default:postgres-9-3"
port:
...
snapshot_create_time:
  description: When the snapshot was initiated
  returned: success
  type: str
  sample: "2014-02-28T21:28:32.000Z"
snapshot_type:
  description: Whether the snapshot was automated or manual
  returned: success
  type: str
  sample: "automated"
status:
  ...
  sample: "available"
vpc_id:
  description: VPC ID of the source database
  returned: success
  type: str
  sample: "vpc-4c63175a"
'''
...
def find_snapshot_facts(module, conn, snapshot_id=None, instance_id=None, max_records=None,
                        id_regex=None, snapshot_type=None, sort=None, sort_order=None,
                        sort_start=None, sort_end=None, status=None):
